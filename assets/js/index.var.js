						...
						(n = [
							...
							},
							{
								...
								value: function () {
									...
									return (
										this.start &&
											(n = this.options.minDurations[this.type] + this.start - Date.now()) < 0 &&
											(n = 0),
									...
									if (
										...
										for (var e = 0, n = ['mouseenter', 'mouseleave']; e < n.length; e++) {
											...
											this.addEvent(o, function () {
												t.isDeleted() ||
													(t.toggleClass(l.klass.progressBarPause), t.timer.toggle());
											});
										}
									}
								},
								...
								value: function (t) {
									...
									switch (t.code) {
										...
										case 'Tab':
											if (
												(t.preventDefault(),
												'confirm' !== this.type || !1 === this[f.ids.confirmCancel])
											)
												return !0;
											var e = this.okBtn;
											t.shiftKey
